function prepare(a)
{
    ...
    {
        var c=a[b];
        partsData[b]={el:c,startX:0,endX:0,startY:0,endY:0,startRotation:0,endRotation:0,startOpacity:1,endOpacity:1}
    }
}

function animateParts(a)
{
    var b=1e3,c=Date.now(),d=c+b;animated=!0,requestAnimationFrame(function(){c=Date.now(),partsStep(a,b,c,d)})
}
